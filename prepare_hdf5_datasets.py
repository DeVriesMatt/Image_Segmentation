...
#------------Path of the images --------------------------------------------------------------
#train
original_imgs_train = "./dataset/train/"
groundTruth_imgs_train = "./dataset/train_GT/"
borderMasks_imgs_train = "./DRIVE/training/mask/"
#test
original_imgs_test = "./dataset/test/"
groundTruth_imgs_test = "./dataset/test_GT/"
...
def get_datasets(imgs_dir, groundTruth_dir, train_test="null"):
    ...
    for path, subdirs, files in os.walk(imgs_dir): #list all files, directories in the path
        for i in range(len(files)):
            ...
            groundTruth_name = files[i][0:6] + "png"
...
write_hdf5(imgs_train, dataset_path + "train.hdf5")
write_hdf5(groundTruth_train, dataset_path + "train_GT.hdf5")
