...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default='./processed/CHASEDB1/train/')
    parser.add_argument('--valid_path', type=str, default='./processed/CHASEDB1/valid/')
    parser.add_argument('--test_path', type=str, default='./processed/CHASEDB1/test/')
